...
const msalConfig = {
    auth: {
        ...
        redirectUri: window.location.hostname === 'localhost' ? 'http://localhost:8080' : 'https://red-dune-0430ceb03.2.azurestaticapps.net' : 'https://m365healthdashboard.gocloud.zone'
    },
    cache: {
